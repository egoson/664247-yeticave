    ...
    <form enctype="multipart/form-data" class="form form--add-lot container <?=$classname?>" action="add.php" method="post" > <!-- form--invalid -->
      ...
      <div class="form__container-two">
        ...
        <div class="form__item <?=$classname?>"> <!-- form__item--invalid -->
          ...
          <input id="lot-name" type="text" name="lot-name" placeholder="Введите название лота" value="<?=$lot_name_cur?>" >
        ...
        <div class="form__item <?=$classname;?>">
          ...
          <select id="category"  name="category" >
            <option><?=$category_cur = $category_cur ? $category_cur : "Выберите категорию";?></option>
              <?php
              foreach ($equipments as $item): ?>
      ...
      <div class="form__container-three">
        ...
        <div class="form__item <?=$classname;?>">
          ...
          <input class="form__input-date" id="close_sale" type="date" name="lot-date" value="<?=$lot_date_cur;?>">
